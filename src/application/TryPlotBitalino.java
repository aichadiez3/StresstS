	        ...
	        try {
	            ...
	            for (int j = 0; j < 1000; j++) {
	                ...
	                for (int i = 0; i < frame.length; i++) {
	                	...
	                	//System.out.println(df.format(x_axis.floatValue()) + " value:" + frame[i].analog[0] + " "+ dataECG.getData().toString());
	            ...
	            Logger.getLogger(TryPlotBitalino.class.getName()).log(Level.SEVERE, null, ex);
	        } catch (Throwable ex) {
	            Logger.getLogger(TryPlotBitalino.class.getName()).log(Level.SEVERE, null, ex);
	        } finally {
	            try {
